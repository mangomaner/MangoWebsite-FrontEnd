...
/** 改名接口 POST /api/user/register */
export async function changeName(body: API.ChangeNameParams, options?: { [key: string]: any }) {
  return request<API.RegisterResult>('/api/user/changeName', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
